...
Las funcionalidades actuales que nos proporciona Facturini son las tipicas CRUD. A parte de estas, también podemos imprimir
...
vaya aplicando refactoring iré publicando nuevas versiones con cada post. Así, podremos ir viendo como va mejorando iteración 
